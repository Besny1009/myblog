# Generated by Django 2.1 on 2020-02-27 09:48
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img', models.ImageField(blank=True, null=True, upload_to='artical_img/%Y/%m/%d', verbose_name='文章图片')),
        ...
        migrations.AddField(
            model_name='artical',
            name='tui',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='blog.Tui'),
        ),
        migrations.AddField(
            model_name='artical',
            name='user',
